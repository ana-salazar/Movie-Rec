...
class Movie:
    ...
    def format_runtime(self):
        """
        Returns the runtime in its original format (ex: '2h 20m')
        """
        ...
        if hours > 0 and minutes == 0:
            return f"{hours}h"  # Added 'h' to match the expected format
...
class MovieRecommender:
    ...
    def display_recommendations(self, recommendations, sort_by=None):
        ...
        for movie in recommendations:
            ...
            print(f"   Genre: {movie.genre} | Certificate: {movie.certificate} | Runtime: {movie.format_runtime()}")
...
if __name__ == "__main__":
    ...
    recommender.display_recommendations(recommendations, sort_by="rating")
